...
// smoothing (0..1) högre = snabbare men mer skak
const SMOOTH = 0.18;

// debug
let DEBUG = false;

// --- matchpunkter: (lat, lon) -> (x,y) i bildens pixelkoordinater ---
const CAL = [
...
let imgFit = null;     // {left, top, w, h, natW, natH}
let smoothX = null;
let smoothY = null;
